...
def RunTest(rho, n_community, pool_size, D=D, gsigma=gsigma, tau_0_dist=tau_0_dist):
    output = {}
...
if __name__=="__main__":
    ...
    D1, gsigma1, tau0_dist1 = parameters_list[parameters_ind]
    output = RunTest(rho, n_community, pool_size, D1, gsigma1, tau0_dist1)
    pickle.dump(output, open(f"../data/seq_vs_co_lag_new/rho={rho}_parameters={parameters_ind}_pairwise.pkl", "wb"))
